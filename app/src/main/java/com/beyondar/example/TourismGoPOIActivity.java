...
public class TourismGoPOIActivity extends FragmentActivity implements OnClickBeyondarObjectListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mBeyondarFragment.setSensorDelay(SensorManager.SENSOR_DELAY_FASTEST);
